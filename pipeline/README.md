...
- **채점근거 공백**: 형사법 변시 1~5회(조균석 책이 QR 온라인 제공으로 전환해 추출 불가), 민사법 변시 **1·2·3회**(정연석 책에 요약만 있음 — 건당 400~1,600자). 5·9·12·14회는 재OCR로 보강돼 지금은 충분하다. 1·2·3회는 `casebook_cases.json`의 「민민소 사례 CBT실전답안」에 회차당 1.3만~1.5만 자가 붙어 있으니 거기서 메울 수 있다.
